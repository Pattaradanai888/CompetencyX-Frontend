export default {
  ...
  roadmaps: {
    ...
    section2AltCopy:
      'Your capability score on each topic this role is assessed on.',
    knowledgeFit: 'Knowledge fit',
    capabilityAlignment: 'Capability alignment',
    currentReadiness: 'current readiness',
    knowledgeFitCopy:
      'Your knowledge fit blends role discovery signals with the skill assessment evidence for this role’s own topics.',
    strongest: 'Strongest',
    ...
    strengthHold: 'Consistent strength',
    relativeStrength: 'Relatively strongest — still room to grow',
    skillCalibration: 'Skill calibration',
    roleTrack: '{role} track',
    saveErrorTitle: 'Could not save Skill Assessment',
    saveTimeoutMessage: 'Saving took too long. Please try again.',
    capabilityScale: 'Capability scale',
    capabilityScaleRange: '1 low / 10 high',
    liveBlend: 'Skill assessment live blend',
