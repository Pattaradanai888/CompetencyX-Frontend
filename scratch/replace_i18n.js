...
const pages = [
  ...
  {
    key: 'questionnaire',
    path: 'app/components/roadmaps/RoadmapQuestionnaire.vue',
  },
  {
    key: 'dashboard',
    path: 'app/components/roadmaps/RoadmapResultDashboard.vue',
  },
]
...
for (const p of pages) {
  ...
  const enRetStart = content.lastIndexOf(
    'return {',
    content.indexOf('})', tStart),
  )
  let enRetEnd = -1
  let braceCount = 0
